...
const App = () => {
  ...
  const calculate = () => {
    try {
      ...
      const expressionFunction = new Function('return ' + result);
      setResult(expressionFunction().toString());
    } catch (error) {
      setResult("error");
    }
  };
    ...
    <div className={`app ${theme}`}>
      <div className="container">
        ...
        <div className="keypad">
          ...
          <button className="highlight" onClick={backspace} id="delete">
            DEL
          </button>
          ...
          <button className="highlight" onClick={reset} id="clear">
            RESET
          </button>
          <button className="action" onClick={calculate} id="result">
            =
          </button>
        </div>
      </div>
